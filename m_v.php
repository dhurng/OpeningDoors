                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="wow bounceInDown" data-wow-delay="0.4s">
                                <div class="section-heading">
                                    <h2>Medicine and Volunteerism</h2>
                                </div>
                            </div>

                            <h4><strong>The Why</strong></h4>
                            <p>
                                There is more to patient care than just clinical care. There is also more to physician education than amassing credentials and publishing research. Humanism was also an integral part of this healing profession as it is a quality we esteem in prominent figures. Therefore, we believe it is of utmost import to devote one's time towards serving the community in a multitude of different ways.
                            </p>
                            <div class="wow fadeInDown" data-wow-delay="0.8s">
                            <img src="img/M_V/mv_1227_1.jpg" width="500" > </br>
                            </div>

                            <h4><strong>Where we come in</strong></h4>
                            <p>
                                By collaborating with dedicated individuals in medicine, we help provide various events emphasizing the importance of the community spirit and service in medicine.    
                            </p>
                            <div class="wow fadeInLeft" data-wow-delay="0.8s">
                                <img src="img/M_V/mv_1227_2.jpg" width="500"> </br>

                            </div>

                            <h4><strong>The Impact</strong></h4>
                            <p>
                                We help provide pizza and volunteer opportunities for medical students at Temple University School of Medicine. 
                                </br>
                            </p>
                            <div class="wow fadeInRight" data-wow-delay="0.8s">
                                <img src="img/M_V/mv_1227_3.jpg" width="500" >
                            </div>
