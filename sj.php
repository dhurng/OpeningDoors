<html lang="en">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    	...
    	<section id="sj-main" class="home-section text-center">
    		...
    		<div class="container">
    			...
    			<div class="col-lg-8 col-lg-offset-2">
    			    ...
    			    <p>
    				Students attending inner city high schools are stuck in unfortunate circumstances.
    				They suffer from a lack of financial and educational support from parents and although
    				hundreds of thousands of students are eligible for tutoring at no cost under the No Child
    				...
    				adulthood, most students cannot achieve their potential.
    			    </p>
    			    <div class="wow fadeInDown" data-wow-delay="0.8s">
    				<img src="img/sj-proj/1.jpg" width="500" height="500"> </br>
    			    </div>
    			    <h4><strong>The Do</strong></h4>
    			    <p>
    				Our organization works through volunteers to help out inner city youth. Few nonprofits cater
    				to them, and we want to improve their lives by tutoring them, providing guidance and creating
    				a supportive environment. We recognize the importance of incorporating both tutoring and extracurricular
    				recreation to effect comprehensive life improvements so in addition to providing academic support, we host
    				social events such as bowling, going out for food, playing pool or air hockey.
    			    </p>
    			    <div class="wow fadeInLeft" data-wow-delay="0.8s">
    				<img src="img/sj-proj/2.jpg"> </br>
    			    </div>
    			    <h4><strong>The Impact</strong></h4>
    			    <p>
    				We were able to achieve a statistically significant grade improvement for over 40 students last year.
    				Our volunteers currently help over 150 at risk youth at Lincoln High School this semester. </br>
    			    </p>
    			    <div class="wow fadeInRight" data-wow-delay="0.8s">
    				<img src="img/sj-proj/3.jpg">
    			    </div>
    			</div>
    		    </div>
    		</div>
